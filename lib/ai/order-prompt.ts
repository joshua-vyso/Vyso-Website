...
- "order_notes" = short order/delivery instructions printed on the document, or null. Do not repeat all line items here. NEVER put terms and conditions, conditions of purchase, general conditions, legal clauses, indemnities, warranties, governing-law text or rights language ("the Purchaser reserves the right to cancel this Order", "may be cancelled in the event of…") in this field. A formal purchase order's terms-and-conditions section is not order notes: it is standing contract text printed on every order that buyer has ever sent, it says nothing about THIS order, and repeating it here makes a live order look like a cancelled one. Notes are instructions about the current delivery — "deliver before 10am", "call on arrival", "use the stores entrance" — and null is the right answer far more often than not.
