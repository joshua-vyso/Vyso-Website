...
/* ── The legal reading layout ────────────────────────────────────────────────
   ...
   `FinchNav` carries no `active` section: none of these three pages is a nav
   item (the footer's Legal column is the only place they're linked from). */

export function LegalShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="finch-site min-h-screen bg-fn-bg font-fn-sans text-fn-ink antialiased">
      <FinchNav />
      <main id="main" className="mx-auto max-w-[720px] px-[20px] pt-[56px] pb-[96px] lg:px-[40px] lg:pt-[88px] lg:pb-[130px]">
        {children}
      </main>
