...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Operations audit", href: "/operations-audit" },
      { label: "Integrations", href: "/integrations" },
      { label: "Pricing FAQ", href: "/pricing-faq" },
      { label: "Compare Vyso", href: "/compare" },
      { label: "Vyso vs spreadsheets", href: "/compare/vyso-vs-spreadsheets" },
      { label: "Vyso vs ERP systems", href: "/compare/vyso-vs-erp-systems" },
    ],
  },
  {
